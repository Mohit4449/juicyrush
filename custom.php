...
<body>
  ...
  <form id="customJuiceForm" method="POST" action="save_custom_juice.php">
    <div class="fruits">
      <?php while ($row = mysqli_fetch_assoc($result)) { ?>
        <label class="fruit-card">
          <input type="checkbox" name="fruits[]" value="<?= $row['id'] ?>" data-price="<?= $row['price'] ?>">
    ...
    <div class="size">
      <label>
        <input type="radio" name="size" value="250" checked> 250ml (+₹0)
      </label>
      <label>
        <input type="radio" name="size" value="500"> 500ml (+₹30)
      </label>
      <label>
        <input type="radio" name="size" value="1000"> 1L (+₹60)
      </label>
    </div>
